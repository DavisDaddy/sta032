...
programming.  (A `Reference Class` is actually a special kind of `S4` class.)
We won't be directly concerned with these in this class.
...
```{r sortDataFrame, eval=FALSE, tidy=FALSE}
...
```{r noPrintInFn, eval=FALSE, tidy=FALSE}
